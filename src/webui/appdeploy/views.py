...
from utils import get_apps_list
...
def get_deploy_form(request, dialog_name, action, filters):
        ...
        return render_to_response('appdeploy/deployform.html', {'action':action, 'filters':filters, 'form':DeployForm([]), 'dialog_name': dialog_name}, context_instance=RequestContext(request))
